...
void TestGameApp::Init()
{
	...
	SInput->RegisterInput("PlayAudio", "", "", "joystick a", "", 10.0f, 0.1f, 10.0f, false, Button, MouseX, -1);
	...
	// Add a light
	LightData light1 = DirectionalLight(DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), DirectX::XMFLOAT3(-1.0f, -1.0f, 1.0f), 0.8f, DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), true);
	LightData light2 = DirectionalLight(DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), DirectX::XMFLOAT3(+1.0f, -1.0f, 1.0f), 0.8f, DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), true);
	CurrentActiveScene()->AddLight(light1);
	CurrentActiveScene()->AddLight(light2);
